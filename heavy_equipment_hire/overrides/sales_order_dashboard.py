...
from erpnext.selling.doctype.sales_order.sales_order_dashboard import get_data as get_erpnext_sales_order_dashboard


def get_data(data=None):
	if data is None:
		data = get_erpnext_sales_order_dashboard()
